...
(function() {
  ...
  exports.Import = Import = (function(_super) {
    ...
    Import.prototype.compileNode = function(o) {
      ...
      if (filename in Import.imported) imported = Import.imported[filename];
      if (!(importingFile || imported === true)) delayedEnabled = true;
      if (importingFile && imported === false) delayedEnabled = true;
      if (delayedEnabled) {
    ...
    Import.prototype.checkImports = function(o, variable, file) {
      ...
      if (!(file in Import.imported)) {
        ...
        try {
          ...
          if (relative) ex.filename = relative;
          throw ex;
        }
