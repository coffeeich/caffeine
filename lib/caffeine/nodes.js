// Generated by Caffeine 0.2.6
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, FileSystem, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, Import, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Lexer, Literal, METHOD_DEF, NEGATE, NO, NativeImport, Obj, Op, Package, Param, Parens, Path, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, parser, some, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      var assigns, code, declars, exp, i, imports, opts, packages, poof, poofs, post, rest, scope, spaced, _i, _j, _len, _len1, _ref2, _ref3, _ref4, _ref5;
      code = post = '';
      _ref2 = this.expressions;
      for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
        exp = _ref2[i];
      ...
      if (scope.expressions === this) {
        if (scope === Scope.root) {
          ...
          opts = extend({}, o);
          opts.scope = poof;
          _ref5 = Package.flush(opts);
          for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
            packages = _ref5[_j];
            poof.assign.apply(poof, packages);
          }
          if (imports = Import.flush(opts)) {
            poof.assign.apply(poof, imports);
          }
        }
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      var call, decl, imported, klass, lname, name, params, _ref2;
  ...
  exports.Package = Package = (function(_super) {
    ...
    Package.prototype.compileNode = function(o) {
      var access, call, className, code, definition, isNode, item, key, literal, namespace, pack, whenCompile, _i, _j, _len, _len1, _name, _ref2, _ref3;
      pack = Package.packages;
      _ref2 = this.namespace;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        item = _ref2[_i];
      ...
      namespace = new Value(new Literal(namespace.shift().compile(o)), (function() {
        var _j, _len1, _results;
        _results = [];
        for (_j = 0, _len1 = namespace.length; _j < _len1; _j++) {
          item = namespace[_j];
      ...
      for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
        ...
        if (key in Package.defined) {
          if (FileSystem && !o.filename) {
            isNode = true;
          }
          if (Import.rootFile && Import.rootFile === o.filename) {
            whenCompile = true;
          }
          if (isNode || whenCompile) {
            continue;
          }
  ...
  exports.NativeImport = NativeImport = (function(_super) {

    __extends(NativeImport, _super);

    function NativeImport(location) {
      var q1, q2, _i, _ref2;
      _ref2 = location.split(''), q1 = _ref2[0], location = 3 <= _ref2.length ? __slice.call(_ref2, 1, _i = _ref2.length - 1) : (_i = 1, []), q2 = _ref2[_i++];
    ...
    NativeImport.prototype.filename = function(o) {
    ...
    NativeImport.prototype.compileNode = function(o) {
      return multident(FileSystem.readFileSync(this.filename(o), 'utf8').replace(/\s+$/, ''), o.indent);
    };
  ...
  exports.Import = Import = (function(_super) {
    ...
    Import.prototype.compileNode = function(o) {
      var args, call, delayedEnabled, filename, identifier, imported, importingFile, variable, word, _ref2;
      variable = this.searchPath[this.searchPath.length - 1].compile(o);
      identifier = ((_ref2 = this.identifier) != null ? _ref2.compile(o) : void 0) || variable;
      if (!(Path && FileSystem)) {
      ...
      importingFile = o.importingFile === filename;
      if (filename in Import.imported) {
        imported = Import.imported[filename];
      }
      if (!(importingFile || imported === true)) {
        delayedEnabled = true;
      }
      if (importingFile && imported === false) {
        delayedEnabled = true;
      }
      if (delayedEnabled) {
    ...
    Import.prototype.checkImports = function(o, variable, file) {
      ...
      importKey = (relative || Path.basename(file)).replace(/\.coffee$/, "");
    ...
    Import.assignImports = function(o) {
      var call, code, codeBlock, importKey, _i, _len, _ref2, _ref3;
      o = extend({}, o);
      o.indent += TAB;
      code = new Code([]);
      ...
      _ref2 = Import.properties;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        _ref3 = _ref2[_i], importKey = _ref3[0], codeBlock = _ref3[1];
    ...
    Import.importedDeclaration = function(o, variable) {
      ...
      if (!(variable in Import.importedDeclarations)) {
        return null;
      }
      if (o.scope !== Scope.root) {
        return null;
      }
