...
(function() {
  ...
  JS_KEYWORDS = ['true', 'false', 'null', 'this', 'new', 'delete', 'typeof', 'in', 'instanceof', 'return', 'throw', 'break', 'continue', 'debugger', 'if', 'else', 'switch', 'for', 'while', 'do', 'try', 'catch', 'finally', 'class', 'extends', 'super', 'package', 'import', 'as'];
  ...
  RESERVED = ['case', 'default', 'function', 'var', 'void', 'with', 'const', 'let', 'enum', 'export', 'native', '__hasProp', '__extends', '__slice', '__bind', '__imports', '__indexOf', 'implements', 'interface', 'private', 'protected', 'public', 'static', 'yield'];
